...
describe("bookConsultation", () => {
  ...
  it("delegates to the repository and files the confirmation notification (RB-24)", async () => {
    const wizyta = { id: "v1" };
  ...
  it("propagates SlotAlreadyTakenError and files no notification when the slot was taken", async () => {
